...
def get_read_options():
    ...
    for x in range(5):
        read_options.selected_fields.append("Stay_In_Current_City_Years_%d" % (x)) 
...
def get_training_data():
    ...
    session = get_session(client, get_table_ref(), get_read_options(), "projects/{}".format(get_table_ref().project_id))
